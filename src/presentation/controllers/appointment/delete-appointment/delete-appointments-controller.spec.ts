import { DeleteAppointmentController } from './delete-appointments-controller'
import { HttpRequest, DeleteAppointment, LoadAppointmentById } from './delete-appointments-controller-protocols'
