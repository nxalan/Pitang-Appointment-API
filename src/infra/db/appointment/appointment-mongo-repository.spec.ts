  ...
  describe('Add', () => {
    ...
    describe('LoadById', () => {
      test('Should return an appointment on loadById success', async () => {
        ...
        const sut = makeSut()
        const appointment = await sut.loadById(res.insertedId.toString())
        expect(appointment).toBeTruthy()
        expect(appointment.id).toBeTruthy()
      })
    })
    ...
    describe('loadRestrictedHours', () => {
      test('Should return a list of restricted hours', async () => {
